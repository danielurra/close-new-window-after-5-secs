...
## Javascript function
Below function make use of the **window.open()** pre-defined `window method` to open a new web page, it accepts three arguments:<br>
* website URL
...
by using the `<script></script>` tags or in a separated file called e.g. **script.js** see example below:<br>
```javascript
function opNeWi() {
